    ...
    <body>
        <div class="container">
            ...
            <div class="scopes">
                ...
                <div class="scope-item" style="color: #999;"><strike>pages_manage_metadata</strike> - Not available via Facebook Login</div>
            </div>
        ...
        <script>
            ...
            function fbLogin() {{
                FB.login(function(response) {{
                    ...
                    scope: 'instagram_basic,instagram_manage_messages,pages_show_list,pages_read_engagement,instagram_content_publish,business_management',
                    auth_type: 'rerequest'
                }});
            }}
