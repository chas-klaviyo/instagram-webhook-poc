        ...
        <div class="container">
            ...
            <div class="section">
                ...
                <ol style="text-align: left;">
                    ...
                    <li>Grant permissions: <code>pages_show_list</code>, <code>instagram_basic</code>, <code>business_management</code></li>
        ...
        <script>
            ...
            function fbLogin() {{
                FB.login(function(response) {{
                    ...
                    scope: 'instagram_basic,instagram_manage_messages,instagram_manage_comments,pages_show_list,pages_read_engagement,instagram_content_publish,business_management',
                    auth_type: 'rerequest'
                }});
            }}
